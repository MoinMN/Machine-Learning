...
master = Tk()
master.title("Moin MN => 211P030 Customer Segmentation using Machine Learning")

Label(master, text="Moin MN => 211P030 Customer Segmentation using Machine Learning", bg="Yellow", fg="black").grid(row=0, columnspan=2)
