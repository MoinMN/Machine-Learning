...
print("\nClassification Report By Moin MN 211P030:")
print(classification_report(y_test, y_pred, target_names=data.target_names))
# Optional: Feature Importance Plot
lgb.plot_importance(lgb_model, max_num_features=10, importance_type='split', title='Feature Importance By Moin MN 211P030')
plt.show()